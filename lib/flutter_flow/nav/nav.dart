...
class AppStateNotifier extends ChangeNotifier {
  DengaLogisticsFirebaseUser? initialUser;
  DengaLogisticsFirebaseUser? user;
  ...
  void update(DengaLogisticsFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'LoadingPayment',
              path: 'loadingPayment',
              builder: (context, params) => LoadingPaymentWidget(),
            ),
            FFRoute(
              name: 'PaymentMethod',
              path: 'paymentMethod',
            ...
            FFRoute(
              name: 'DroneBookings',
              path: 'droneBookings',
              builder: (context, params) => DroneBookingsWidget(),
            ),
            FFRoute(
              name: 'BikesBookings',
              path: 'bikesBookings',
              builder: (context, params) => BikesBookingsWidget(),
            )
